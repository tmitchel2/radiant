...
/// <summary>
/// The Radiant color roles as one spec version defines them. Upstream's <c>ColorSpecDelegate</c>;
/// <see cref="RadiantDynamicColors"/> exposes the latest one, whose roles fall back to earlier
