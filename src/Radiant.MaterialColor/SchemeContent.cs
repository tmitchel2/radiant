...
public sealed class SchemeContent : DynamicScheme
{
    ...
    public SchemeContent(
        ...
        : base(sourceColorHct, Variant.Content, isDark, contrastLevel, platform, specVersion)
    {
    }

    /// <summary>A Content scheme from several source colors; the first is the main one.</summary>
    public SchemeContent(
        ...
        SpecVersion specVersion = DefaultSpecVersion,
        Platform platform = DefaultPlatform)
        : base(sourceColorHcts, Variant.Content, isDark, contrastLevel, platform, specVersion)
    {
    }
}
