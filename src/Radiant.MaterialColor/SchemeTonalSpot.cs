...
/// <summary>A Dynamic Color theme with low to medium colorfulness and a tertiary tonal palette with a hue related to the source color. The default Material You theme on Android 12 and 13.</summary>
