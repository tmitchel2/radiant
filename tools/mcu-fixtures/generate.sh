#!/usr/bin/env bash
# Regenerates the fixtures in src/Radiant.MaterialColor.Tests/Fixtures from upstream
# material-color-utilities at the commit Radiant.MaterialColor is ported from.
#
...
repo="$(cd "$here/../.." && pwd)"
out="$repo/src/Radiant.MaterialColor.Tests/Fixtures"
work="$(mktemp -d)"
